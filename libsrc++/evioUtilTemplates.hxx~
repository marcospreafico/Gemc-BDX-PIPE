...
public:
  static int evioContentType(void) noexcept(false) {
...
template <> class evioUtil<uint32_t>     {public: static int evioContentType(void)  noexcept(false) {return(0x1);}};
template <> class evioUtil<float>        {public: static int evioContentType(void)  noexcept(false) {return(0x2);}};
template <> class evioUtil<string>       {public: static int evioContentType(void)  noexcept(false) {return(0x3);}};
template <> class evioUtil<string&>      {public: static int evioContentType(void)  noexcept(false) {return(0x3);}};
template <> class evioUtil<int16_t>      {public: static int evioContentType(void)  noexcept(false) {return(0x4);}};
template <> class evioUtil<uint16_t>     {public: static int evioContentType(void)  noexcept(false) {return(0x5);}};
template <> class evioUtil<int8_t>       {public: static int evioContentType(void)  noexcept(false) {return(0x6);}};
template <> class evioUtil<uint8_t>      {public: static int evioContentType(void)  noexcept(false) {return(0x7);}};
template <> class evioUtil<double>       {public: static int evioContentType(void)  noexcept(false) {return(0x8);}};
template <> class evioUtil<int64_t>      {public: static int evioContentType(void)  noexcept(false) {return(0x9);}};
template <> class evioUtil<uint64_t>     {public: static int evioContentType(void)  noexcept(false) {return(0xa);}};
template <> class evioUtil<int32_t>      {public: static int evioContentType(void)  noexcept(false) {return(0xb);}};
 ...
 */
template <typename T> evioDOMNodeP evioDOMNode::createEvioDOMNode(uint16_t tag, uint8_t num) noexcept(false) {
 ...
 * @return Pointer to new node
 */
template <typename T> evioDOMNodeP evioDOMNode::createEvioDOMNode(const string &name, const evioDictionary *dictionary) noexcept(false) {
...
template <typename T> evioDOMNodeP evioDOMNode::createEvioDOMNode(const string &name, const evioDictionary *dictionary, T *t, 
                                                                  void *userArg, ContainerType cType) noexcept(false) {
...
template <typename T> void evioDOMNode::append(T tVal) noexcept(false) {
 ...
 */
template <typename T> void evioDOMNode::append(const vector<T> &tVec) noexcept(false) {
  if(contentType!=evioUtil<T>::evioContentType())
 ...
 */
template <typename T> void evioDOMNode::append(const T* tBuf, int len) noexcept(false) {
  if(contentType!=evioUtil<T>::evioContentType())
    throw(evioException(0,"?evioDOMNode::append...not appropriate node",__FILE__,__FUNCTION__,__LINE__));
  evioDOMLeafNode<T> *l = static_cast<evioDOMLeafNode<T>*>(this);
 ...
 * @param tVec vector<T> of data
 */
template <typename T> void evioDOMNode::replace(const vector<T> &tVec) noexcept(false) {
  if(contentType!=evioUtil<T>::evioContentType())
 ...
 * @param len Length of buffer
 */
template <typename T> void evioDOMNode::replace(const T* tBuf, int len) noexcept(false) {
  if(contentType!=evioUtil<T>::evioContentType())
 ...
 */
template <typename T> vector<T> *evioDOMNode::getVector(void) noexcept(false) {
 ...
 */
template <typename T> evioDOMNode& evioDOMNode::operator<<(T tVal) noexcept(false) {
  append(tVal);
  return(*this);
}
 ...
 * @return Reference to this
 */
template <typename T> evioDOMNode& evioDOMNode::operator<<(const vector<T> &tVec) noexcept(false) {
  append(tVec);
  return(*this);
}
 ...
 */
template <class Predicate> evioDOMNodeListP evioDOMNode::getChildren(Predicate pred) noexcept(false) {
...
template <typename T> evioDOMLeafNode<T>::evioDOMLeafNode(evioDOMNodeP par, uint16_t tag, uint8_t num)
  noexcept(false) : evioDOMNode(par,tag,num,evioUtil<T>::evioContentType()) {
}
...
template <typename T> evioDOMLeafNode<T>::evioDOMLeafNode(evioDOMNodeP par, uint16_t tag, uint8_t num, const vector<T> &v)
  noexcept(false) : evioDOMNode(par,tag,num,evioUtil<T>::evioContentType()), data(v) {
}
...
template <typename T> evioDOMLeafNode<T>::evioDOMLeafNode(evioDOMNodeP par, uint16_t tag, uint8_t num, const T* p, int ndata) 
  noexcept(false) : evioDOMNode(par,tag,num,evioUtil<T>::evioContentType()), data(p, p + ndata) {
}
 ...
 */
template <class Predicate> evioDOMNodeListP evioDOMTree::getNodeList(Predicate pred) noexcept(false) {
 ...
 */
template <class Predicate> evioDOMNodeP evioDOMTree::getFirstNode(Predicate pred) noexcept(false) {
 ...
 * @return Pointer to node
 */
template <class Predicate> evioDOMNodeP evioDOMTree::findFirstNode(evioDOMNodeP pNode, Predicate pred) noexcept(false) {
 ...
 */
template <typename T> vector<T> *evioDOMTree::getVectorUnique(void) noexcept(false) {
 ...
 */
template <typename T, class Predicate> vector<T> *evioDOMTree::getVectorUnique(Predicate pred) noexcept(false) {
 ...
 */
template <typename T> void evioDOMTree::addBank(uint16_t tag, uint8_t num, const vector<T> &dataVec) noexcept(false) {
 ...
 * @param dataVec vector<T> of data
 */
template <typename T> void evioDOMTree::addBank(tagNum tn, const vector<T> &dataVec) noexcept(false) {
 ...
 * @param dataLen Length of array
 */
template <typename T> void evioDOMTree::addBank(tagNum tn, const T* dataBuf, int dataLen) noexcept(false) {
 ...
 * @param dataVec vector<T> of data
 */
template <typename T> void evioDOMTree::addBank(const string &name, const vector<T> &dataVec) noexcept(false) {
 ...
 * @param dataLen Length of array
 */
template <typename T> void evioDOMTree::addBank(const string &name, const T* dataBuf, int dataLen) noexcept(false) {
 ...
 * @return Pointer to new node
 */
template <typename T> evioDOMNodeP evioDOMTree::createNode(const string &name, const vector<T> &tVec) const noexcept(false) {
 ...
 * @return Pointer to new node
 */
template <typename T> evioDOMNodeP evioDOMTree::createNode(const string &name, const T* t, int len) const noexcept(false) {
...
template <typename T> evioDOMNodeP evioDOMTree::createNode(const string &name, T *t, 
                                              void* T::*mfp(evioDOMNodeP c, void *userArg),
                                              void *userArg, ContainerType cType) const noexcept(false) {
